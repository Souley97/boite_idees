...
if (isset($_GET['id'])) {
    ...
    // Récupérez les détails de l'idée à supprimer depuis la base de données
    ...
    if ($idee) {
        // Affichez les détails de l'idée et le formulaire de confirmation de suppression
        ?>
       <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Supprimer une Idée</title>
...
<body class="container mt-5">
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="mb-0">Supprimer l'idée</h1>
        </div>
        <div class="card-body">
            <p class="lead">Êtes-vous sûr de vouloir supprimer cette idée ?</p>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
        ...
        // L'idée n'a pas été trouvée
        echo "L'idée avec l'ID spécifié n'a pas été trouvée.";
    }
} else {
    // L'ID n'est pas spécifié dans l'URL
    echo "L'ID de l'idée n'est pas spécifié.";
}
?>
